...
| **"As you design, so should you analyse."**

## Sample size for validation of a screening test

An existing screening instrument to detect condition X will be translated and validated in Sri Lanka. The reported sensitivity and specificity of this instrument are 90% and 85%, respectively. The research team has access to patients undergoing the diagnostic test. Usually, about 40% of those undergoing the diagnostic test are found to have condition X.\
...
We have very limited data on the prevalence of mental illnesses/ conditions in Sri Lanka. A community survey using a new tool (not validated in Sri Lanka) is being planned. The results of this are needed within six months.

Can you help the research team calculate the sample size for the different components and develop the sampling method?

## Sampling for a National Oral Health Survey

The protocol for the next National Oral Health Survey is being developed.

Issues related to the calculation of the sample size.

Propose an appropriate sampling scheme.
